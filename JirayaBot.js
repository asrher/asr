...
"description": `عرض اوامر الحيوانات`,
...
break
case 'wallpaperhacker123':
case 'wallpaperhacker2123':
case 'wallpaperharley123':
case 'wallpaperjoke123r':
case 'wallpaperp123ubg':
case 'wallpaper123hp':
case 'wallpaper123hp2':
case 'wallpaper123kpop':
case 'wallpaperblack132pink':
case 'wallpape1123rgame':
...
break
             case 'احزر':
				...
				break
                 ...
                 JirayaBot.sendMessage(from, lovelive, image, {quoted: mek, caption: 'تم'})
				break
...
case 'ملصقي':
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							wmsti = body.slice(11)
							if (!wmsti.includes('|')) return reply(`منشن عالصورة ${prefix}الي تبي احط*`)
