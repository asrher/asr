...
const textImg = (teks) => { return JirayaBot.sendMessage(from, teks, text, {quoted: fgi, thumbnail: fs.readFileSync('./media/dogetb.jpg')})}
...
JirayaBot.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/dogepic1.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}
...
--> Jiraya*/
                ...
                reply(mess.wait)
                   ...
                   break
                   case 'qtr':  
                   anupandao = await fetchJson(`https://some-random-api.ml/animu/quote`)
                   anu1 = await getBuffer(anupandao.link)
                   JirayaBot.sendMessage(from, anu1, video, {caption: `تمم 🦦`, quoted: mek})
                   break
                   case 'بيكاتشو':  
...
break
             case 'احزر':
				...
				case 'انمي':
                 ...
                 JirayaBot.sendMessage(from, highschooldxd, image, {quoted: mek, caption: '! ها أنت ذا'})
				break
				 case 'انمي1':
				 JirayaBot.updatePresence(from, Presence.composing) 
