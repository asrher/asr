...
Ketik *استسلم* untuk استسلم
`.trim()
            if (room.x !== room.o) await conn.sendButton(room.x, str, '© stikerin', 'استسلم', 'استسلم', m, {
                contextInfo: {
                    mentionedJid: conn.parseMention(str)
                }
            })
            await conn.sendButton(room.o, str, '© stikerin', 'استسلم', 'استسلم', m, {
                contextInfo: {
                    mentionedJid: conn.parseMention(str)
                }
            })
